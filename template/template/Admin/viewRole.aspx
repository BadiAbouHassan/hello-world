<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="viewRole.aspx.cs" Inherits="template.Admin.User.viewRole" %>
                    ...
                    <div class="table-responsive">
                        <asp:Table ID="Table1" runat="server" BorderColor="#DADDE1" CellPadding="5" CellSpacing="5" CssClass="table table-bordered table-striped">
                            <asp:TableHeaderRow ID="TableHeaderRow1" runat="server">
                                <asp:TableCell ID="TableCell1" runat="server"><b>Role ID</b></asp:TableCell>
                                <asp:TableCell ID="TableCell2" runat="server"><b>Role Name</b></asp:TableCell>
                                <asp:TableCell ID="TableCell3" runat="server"><b>Predefined</b></asp:TableCell>
                            </asp:TableHeaderRow>
                        </asp:Table>
                    </div>
                </div>
